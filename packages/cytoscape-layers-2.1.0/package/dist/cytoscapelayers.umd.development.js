...
(function (global, factory) {
  ...
  (global = global || self, factory(global.CytoscapeLayers = {}));
  ...
  class CanvasBaseLayer extends ABaseLayer {
    constructor(adapter, doc, options = {}) {
      var _ref, _options$pixelRatio, _window;
      super(adapter);
      this.callbacks = [];
      this.transform = {
        tx: 0,
      ...
      this.pixelRatio = (_ref = (_options$pixelRatio = options.pixelRatio) !== null && _options$pixelRatio !== void 0 ? _options$pixelRatio : ((_window = window) !== null && _window !== void 0 ? _window : {}).devicePixelRatio) !== null && _ref !== void 0 ? _ref : 1;
  ...
  function renderPerEdge(layer, render, options) {
    ...
    const renderer = ctx => {
      ...
      currentEdges.forEach(edge => {
        ...
        const s = impl && impl.startX != null && impl.startY != null ? {
          x: impl.startX,
          y: impl.startY
        } : edge.sourceEndpoint();
        const t = impl && impl.endX != null && impl.endY != null ? {
          x: impl.endX,
          y: impl.endY
        } : edge.targetEndpoint();
  ...
  function renderPerNode(layer, render, options = {}) {
    ...
    if (layer.type === 'html') {
      const matchOptions = { ...baseOptions,
        enter: (node, bb) => {
  ...
  class LayersPlugin {
    constructor(cy) {
      ...
      this.adapter = {
        ...
        inVisibleBounds: p => {
          ...
          return inX(p.x1) && inY(p.y1) || inX(p.x2) && inY(p.y1) || inX(p.x2) && inY(p.y2) || inX(p.x1) && inY(p.y2) || inX((p.x1 + p.x2) / 2) && inY((p.y1 + p.y2) / 2);
        }
      };
    ...
    get layers() {
      return Array.from(this.root.children).map(d => d.__cy_layer).filter(d => d != null);
    }
    getLayers() {
      return this.layers;
    }
    ...
    getLast() {
      ...
      return (_layers = layers[layers.length - 1]) !== null && _layers !== void 0 ? _layers : null;
    }
    getFirst() {
      var _layers$;
      const layers = this.layers;
      return (_layers$ = layers[0]) !== null && _layers$ !== void 0 ? _layers$ : null;
    }
  }
...
//# sourceMappingURL=cytoscapelayers.umd.development.js.map
