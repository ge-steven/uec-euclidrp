...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var _activeArea, _potentialArea, _options, _virtualEdgeAreas, _throttledUpdate, _adder, _remover, _adapter;
    function round2(v) {
    ...
    class BubbleSetPath {
        constructor(adapter, node, nodes, edges, avoidNodes, options = {}) {
            ...
            _activeArea.set(this, { x: 0, y: 0, width: 0, height: 0 });
            _potentialArea.set(this, new Area(4, 0, 0, 0, 0, 0, 0));
            _options.set(this, void 0);
            _virtualEdgeAreas.set(this, new Map());
            _throttledUpdate.set(this, void 0);
            _adder.set(this, void 0);
            _remover.set(this, void 0);
            _adapter.set(this, void 0);
            this.update = () => {
                const bb = this.nodes.union(this.edges).boundingBox(__classPrivateFieldGet(this, _options));
                let potentialAreaDirty = false;
                const padding = Math.max(__classPrivateFieldGet(this, _options).edgeR1, __classPrivateFieldGet(this, _options).nodeR1) + __classPrivateFieldGet(this, _options).morphBuffer;
                ...
                if (__classPrivateFieldGet(this, _activeArea).x !== nextPotentialBB.x || __classPrivateFieldGet(this, _activeArea).y !== nextPotentialBB.y) {
                    potentialAreaDirty = true;
                    __classPrivateFieldSet(this, _potentialArea, Area.fromPixelRegion(nextPotentialBB, __classPrivateFieldGet(this, _options).pixelGroup));
                }
                else if (__classPrivateFieldGet(this, _activeArea).width !== nextPotentialBB.width || __classPrivateFieldGet(this, _activeArea).height !== nextPotentialBB.height) {
                    __classPrivateFieldSet(this, _potentialArea, Area.fromPixelRegion(nextPotentialBB, __classPrivateFieldGet(this, _options).pixelGroup));
                }
                __classPrivateFieldSet(this, _activeArea, nextPotentialBB);
                const potentialArea = __classPrivateFieldGet(this, _potentialArea);
                const cache = new Map();
                if (!potentialAreaDirty) {
                    this.nodes.forEach((n) => {
                        const data = (n.scratch(SCRATCH_KEY) ?? null);
                        if (data && data.area) {
                ...
                const updateNodeData = (n) => {
                    const bb = n.boundingBox(__classPrivateFieldGet(this, _options));
                    let data = (n.scratch(SCRATCH_KEY) ?? null);
                    ...
                    if (!data ||
                        ...
                        if (cache.has(key)) {
                            data.area = __classPrivateFieldGet(this, _potentialArea).copy(cache.get(key), {
                                x: bb.x1 - __classPrivateFieldGet(this, _options).nodeR1,
                                y: bb.y1 - __classPrivateFieldGet(this, _options).nodeR1,
                            });
                        }
                        else {
                            data.area = data.isCircle
                                ? createGenericInfluenceArea(data.shape, potentialArea, __classPrivateFieldGet(this, _options).nodeR1)
                                : createRectangleInfluenceArea(data.shape, potentialArea, __classPrivateFieldGet(this, _options).nodeR1);
                        ...
                        data.area = __classPrivateFieldGet(this, _potentialArea).copy(data.area, {
                            x: bb.x1 - __classPrivateFieldGet(this, _options).nodeR1,
                            y: bb.y1 - __classPrivateFieldGet(this, _options).nodeR1,
                        });
                    }
                ...
                if (!potentialAreaDirty) {
                    __classPrivateFieldGet(this, _virtualEdgeAreas).forEach((value, key) => edgeCache.set(key, value));
                ...
                const updateEdgeArea = (line) => {
                    ...
                    const r = createLineInfluenceArea(line, __classPrivateFieldGet(this, _potentialArea), __classPrivateFieldGet(this, _options).edgeR1);
                    edgeCache.set(key, r);
                    return r;
                };
                const edges = [];
                this.edges.forEach((e) => {
                    ...
                    let data = (e.scratch(SCRATCH_KEY) ?? null);
                ...
                if (__classPrivateFieldGet(this, _options).virtualEdges) {
                    if (updateEdges) {
                        const nonMembersShapes = nonMembers.map((d) => d.shape);
                        const lines = calculateVirtualEdges(memberShapes, nonMembersShapes, __classPrivateFieldGet(this, _options).maxRoutingIterations, __classPrivateFieldGet(this, _options).morphBuffer);
                        __classPrivateFieldGet(this, _virtualEdgeAreas).clear();
                        lines.forEach((line) => {
                            const area = updateEdgeArea(line);
                            const key = toEdgeKey(line);
                            __classPrivateFieldGet(this, _virtualEdgeAreas).set(key, area);
                            edges.push(area);
                        });
                    }
                    else {
                        __classPrivateFieldGet(this, _virtualEdgeAreas).forEach((area) => edges.push(area));
                    }
                }
                const memberAreas = members.map((d) => d.area);
                const nonMemberAreas = nonMembers.map((d) => d.area);
                const path = calculatePotentialOutline(potentialArea, memberAreas, edges, nonMemberAreas, (p) => p.containsElements(memberShapes), __classPrivateFieldGet(this, _options));
            ...
            __classPrivateFieldSet(this, _options, Object.assign({}, defaultOptions, {
                style: {
                    stroke: 'black',
                    fill: 'black',
                    fillOpacity: 0.25,
            ...
            Object.assign(this.node.style, __classPrivateFieldGet(this, _options).style);
            if (__classPrivateFieldGet(this, _options).className) {
                this.node.classList.add(__classPrivateFieldGet(this, _options).className);
            }
            if (__classPrivateFieldGet(this, _options).interactive) {
                this.node.addEventListener('dblclick', () => {
                    this.nodes.select();
                });
            }
            __classPrivateFieldSet(this, _throttledUpdate, lodash_throttle(() => {
                this.update();
            }, __classPrivateFieldGet(this, _options).throttle));
            __classPrivateFieldSet(this, _adder, (e) => {
                e.target.on('add', __classPrivateFieldGet(this, _adder));
                e.target.on('remove', __classPrivateFieldGet(this, _remover));
                __classPrivateFieldGet(this, _throttledUpdate).call(this);
            });
            __classPrivateFieldSet(this, _remover, (e) => {
                e.target.off('add', undefined, __classPrivateFieldGet(this, _adder));
                e.target.off('remove', undefined, __classPrivateFieldGet(this, _remover));
                __classPrivateFieldGet(this, _throttledUpdate).call(this);
            });
            nodes.on('position', __classPrivateFieldGet(this, _throttledUpdate));
            nodes.on('add', __classPrivateFieldGet(this, _adder));
            nodes.on('remove', __classPrivateFieldGet(this, _remover));
            avoidNodes.on('position', __classPrivateFieldGet(this, _throttledUpdate));
            avoidNodes.on('add', __classPrivateFieldGet(this, _adder));
            avoidNodes.on('remove', __classPrivateFieldGet(this, _remover));
            edges.on('move position', __classPrivateFieldGet(this, _throttledUpdate));
            edges.on('add', __classPrivateFieldGet(this, _adder));
            edges.on('remove', __classPrivateFieldGet(this, _remover));
        }
        remove() {
            for (const set of [this.nodes, this.edges, this.avoidNodes]) {
                set.off('move position', undefined, __classPrivateFieldGet(this, _throttledUpdate));
                set.off('add', undefined, __classPrivateFieldGet(this, _adder));
                set.off('remove', undefined, __classPrivateFieldGet(this, _remover));
                set.forEach((d) => {
                    d.scratch(SCRATCH_KEY, {});
                });
            }
            this.node.remove();
            return __classPrivateFieldGet(this, _adapter).remove(this);
        }
    }
    _activeArea = new WeakMap(), _potentialArea = new WeakMap(), _options = new WeakMap(), _virtualEdgeAreas = new WeakMap(), _throttledUpdate = new WeakMap(), _adder = new WeakMap(), _remover = new WeakMap(), _adapter = new WeakMap();

    var _layers, _adapter$1, _cy, _options$1;
    ...
    class BubbleSetsPlugin {
        constructor(cy, options = {}) {
            ...
            _adapter$1.set(this, {
                remove: (path) => {
                    const index = __classPrivateFieldGet(this, _layers).indexOf(path);
                    if (index < 0) {
                        return false;
                    }
                    __classPrivateFieldGet(this, _layers).splice(index, 1);
                    return true;
                },
            });
            _cy.set(this, void 0);
            _options$1.set(this, void 0);
            __classPrivateFieldSet(this, _cy, cy);
            __classPrivateFieldSet(this, _options$1, options);
            this.layer = options.layer ?? cytoscapeLayers.layers(cy).nodeLayer.insertBefore('svg');
        }
        destroy() {
            for (const path of __classPrivateFieldGet(this, _layers)) {
                path.remove();
            }
            this.layer.remove();
        }
        addPath(nodes, edges = __classPrivateFieldGet(this, _cy).collection(), avoidNodes = __classPrivateFieldGet(this, _cy).collection(), options = {}) {
            const node = this.layer.node.ownerDocument.createElementNS(SVG_NAMESPACE, 'path');
            this.layer.node.appendChild(node);
            const path = new BubbleSetPath(__classPrivateFieldGet(this, _adapter$1), node, nodes, edges ?? __classPrivateFieldGet(this, _cy).collection(), avoidNodes ?? __classPrivateFieldGet(this, _cy).collection(), Object.assign({}, __classPrivateFieldGet(this, _options$1), options));
            __classPrivateFieldGet(this, _layers).push(path);
            path.update();
            return path;
        }
        getPaths() {
            return __classPrivateFieldGet(this, _layers).slice();
        }
        removePath(path) {
            const i = __classPrivateFieldGet(this, _layers).indexOf(path);
            if (i < 0) {
                return false;
            }
            return path.remove();
        ...
        update() {
            __classPrivateFieldGet(this, _layers).forEach((p) => p.update());
        }
    }
    _layers = new WeakMap(), _adapter$1 = new WeakMap(), _cy = new WeakMap(), _options$1 = new WeakMap();
